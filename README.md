...
Se crean varios objetos de tipo Aprendiz.
Se utilizan diferentes formas de creación de objetos (constructor con parámetros y constructor vacío + setters).
Los aprendices se almacenan en una lista de tipo ArrayList.
Se recorre la lista utilizando un ciclo for-each.
Se imprime la información de cada aprendiz en consola.
Salida esperada
